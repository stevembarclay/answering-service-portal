# Answering Service Portal — Community Edition
...
The following features are part of the managed deployment and are not included in this repository:
...
- **Billing rule templates** — reusable billing configurations created once and applied across clients
...
Open an issue on this repository to ask about a managed deployment.
...
Use it, fork it, embed it in a commercial product. No copyleft obligation and no separate licence to ask for.
