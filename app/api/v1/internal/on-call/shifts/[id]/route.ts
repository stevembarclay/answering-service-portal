...
export async function PUT(
  ...
  pushCurrentOnCall(context.businessId).catch((err) =>
    logger.error('on-call push failed after shift update', { businessId: context.businessId, error: err })
  )
...
export async function DELETE(
  ...
  // Fire-and-forget: push updated on-call state after shift deletion.
  pushCurrentOnCall(context.businessId).catch((err) =>
    logger.error('on-call push failed after shift delete', { businessId: context.businessId, error: err })
  )
