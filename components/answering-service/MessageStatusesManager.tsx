...
export function MessageStatusesManager({ initialStatuses }: MessageStatusesManagerProps) {
  ...
  const [confirmDeleteStatus, setConfirmDeleteStatus] = useState<BusinessMessageStatus | null>(null)
  ...
  return (
    <div className="rounded-xl border border-border bg-card overflow-hidden">
      ...
      <ConfirmDialog
        open={confirmDeleteStatus !== null}
        title="Delete status?"
        description={confirmDeleteStatus ? `"${confirmDeleteStatus.label}" will be permanently deleted. Messages with this status will be unaffected.` : ''}
        confirmLabel="Delete"
        destructive
        onConfirm={() => {
          if (confirmDeleteStatus) void handleDelete(confirmDeleteStatus)
