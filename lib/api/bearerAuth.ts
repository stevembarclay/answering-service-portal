...
export async function validateBearerToken(
  ...
  // SAFETY: The select above fetches exactly the ApiKeyRow fields. Supabase's maybeSingle()
  // result type does not reflect the exact select shape, so we assert to the local row type.
