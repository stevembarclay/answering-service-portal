...
export async function createStatus(
  ...
  // SAFETY: sort_order is INTEGER NOT NULL in the schema; Supabase types it as number | null.
  ...
  // SAFETY: The select above fetches exactly the StatusRow shape declared at the top of this file.
...
export async function deleteStatus(statusId: string, businessId: string): Promise<void> {
  ...
  // SAFETY: The select on line above fetches `is_system` only; Supabase can't infer the shape.
...
export async function setWorkflowStatus(
  ...
  // SAFETY: The select above fetches `workflow_status_id`; Supabase doesn't infer the narrow shape.
...
export async function assignMessage(
  ...
  // SAFETY: The select above fetches `assigned_to`; Supabase doesn't infer the narrow shape.
