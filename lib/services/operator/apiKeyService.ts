...
/**
 * Returns true if the given API key exists and belongs to the given business.
 * Used to authorize revocation in server actions.
 */
export async function verifyApiKeyOwnership(keyId: string, businessId: string): Promise<boolean> {
