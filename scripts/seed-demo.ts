...
const MESSAGE_TEMPLATES: Record<string, string[]> = {
  urgent: [
    ...
    'Patient reporting severe symptoms and requesting on-call physician callback immediately.',
    'Caller identified as a current patient with an urgent post-procedure concern.',
    'Property tenant reporting a burst pipe — requesting emergency maintenance callback.',
  ],
  'new-client': [
    ...
    'Prospective patient inquiring about new patient appointments and insurance acceptance.',
    'Caller requesting information about services and new patient intake availability.',
    'Prospective tenant inquiring about a listed unit and requesting a showing callback.',
  ],
  appointment: [
    ...
    'Patient calling to reschedule a follow-up appointment.',
    'Caller asking about wait times and whether same-day appointments are available.',
  ],
  'general-info': [
    ...
    'Caller asked about accepted insurance plans and general office hours.',
    'General inquiry about services offered and whether a referral is required.',
  ],
  'after-hours': [
    ...
    'After-hours patient call — non-emergency, requesting nurse callback in the morning.',
    'Evening caller reporting a HVAC issue and requesting a service callback.',
  ],
}
